...
public class EncodingMain2 {
	...
	public static void main(String[] args) {
		...
		test("가", US_ASCII, US_ASCII); // ASCII로 인코딩 불가
		test("가", ISO_8859_1, ISO_8859_1); // ASCII로 인코딩 불가
		...
		test("뷁", EUC_KR, EUC_KR); // EUC-KR로 인코딩 불가
		...
		test("뷁", MS_949, EUC_KR); // EUC-KR로 인코딩 불가
		test("가", EUC_KR, UTF_8);
		test("가", MS_949, UTF_8);
		test("가", UTF_8, MS_949);
